...
export default function Home() {
  ...
  const [additionalSigners, setAdditionalSigners] = useState<
    Array<{ nik: string; passphrase: string }>
  >([{ nik: "", passphrase: "" }]);
  ...
  const signPDF = async () => {
    ...
    if (!nik || !passphrase) {
      openNotif(
        "error",
        "Passphrase Diperlukan",
        "NIK dan passphrase wajib diisi untuk melakukan tanda tangan digital.",
      );
      return;
    }
    ...
    if (!pse?.trim()) {
      openNotif(
        ...
        "Silakan pilih PSrE yang akan digunakan untuk proses TTE.",
      );
    ...
    if (visibleSignature && !imageBase64) {
      openNotif(
        "error",
        "Gambar Tanda Tangan Diperlukan",
    ...
    const Icon = () => {
      ...
      return (
        <div className="w-20 h-20 rounded-full bg-[#E8F7FF] flex items-center justify-center">
          <svg
            className="w-10 h-10 text-[#0C4F81]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
                  ...
                  >
                    {index < arr.length - 1 && (
                      <div
                        className={`absolute top-4 left-1/2 w-full h-[2px] z-0 transition-colors duration-300 ${
                          step > item.id ? "bg-[#2FAAE1]" : "bg-gray-200"
                        }`}
                      />
                    )}
                    <div
                    ...
                    <p
                      className={`mt-2 text-[10px] sm:text-xs font-medium text-center ${
                        step >= item.id ? "text-[#0C4F81]" : "text-gray-400"
                      }`}
                    >
                      {item.label}
                    </p>
            ...
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white/70 backdrop-blur-sm">
              <div className="w-full max-w-md px-6">
                <div className="bg-white rounded-3xl shadow-2xl border border-[#2FAAE1]/30 p-8 text-center">
                  ...
                  <h3 className="mt-6 text-lg font-bold text-[#0C4F81]">
                    Memproses File PDF
                  </h3>
                  ...
                  <div className="mt-5 flex justify-center space-x-2">
                    ...
                    <div
                      className="w-2 h-2 bg-[#2FAAE1] rounded-full animate-bounce"
                      style={{ animationDelay: "0.1s" }}
                    />
                    <div
                      className="w-2 h-2 bg-[#FFA62B] rounded-full animate-bounce"
                    ...
                    <div
                      ...
                      onDrop={async (e) => {
                        if (!canUpload) {
                          ...
                          openNotif(
                            "info",
                            "Jumlah Penanda Tangan Wajib",
                            "Silakan pilih/isi jumlah penanda tangan terlebih dahulu sebelum mengunggah dokumen.",
                          );
                          return;
                        }
                        await handleDrop(e);
        ...
        : isDragActive
          ...
          : "border-gray-300 hover:border-[#FFA62B] hover:bg-orange-50/30 cursor-pointer"
                    ...
                    >
                      ...
                      <p
                        className={`font-semibold text-center text-base sm:text-lg leading-snug ${canUpload ? "text-gray-700" : "text-gray-500"}`}
                      >
                        {canUpload
                          ? isDragActive
                            ? "Lepaskan file di sini..."
                            : "Seret & letakkan file PDF di sini"
                          : "Lengkapi jumlah penanda tangan terlebih dahulu"}
                      </p>

                      <p
                        className={`text-sm mt-2 ${canUpload ? "text-gray-500" : "text-gray-400"}`}
                      >
                        {canUpload
                          ? "atau klik untuk memilih file"
                          : "Setelah itu, upload dokumen akan terbuka"}
                      </p>
                    ...
                    <div className="mt-6 bg-gradient-to-r from-[#E8F7FF] to-[#FFF8E6] border border-[#FFA62B]/30 rounded-2xl p-5">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm text-gray-700">
                          <p className="font-semibold mb-1 text-[#0C4F81]">
                            Tips:
                          </p>
              ...
              <div className="relative z-10">
                <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                  ...
                  <div className="relative">
                    <select
                      value={
                        signerCountMode === "custom" ? "custom" : signerCount
                      }
                      onChange={(e) => {
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">
                        Centang jika Anda termasuk pihak yang menandatangani
                        dokumen
                      </span>
                    </div>
                  </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <button
                  onClick={() => {
                    ...
                    setNik(signerList[0]?.nik || "");
                    setAdditionalSigners([
                      { nik: signerList[1]?.nik || "", passphrase: "" },
                    ]);
                    setShowAdditionalPassphrases([false]);
                    setSigningPhase(1);
                    setStep(3);
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                { id: "BSrE", name: "BSrE", logo: "/assets/images/bsre.webp" },
                {
                  id: "DocuPro",
                  name: "DocuPro",
                  logo: "/assets/images/docupro.webp",
                },
              ].map((item) => (
                <div
                  key={item.id}
      ...
      {step === 3 && (
        <div className="relative min-h-screen bg-gradient-to-br from-[#E8F7FF] via-white to-[#FFF8E6] flex justify-center px-10 py-12">
          ...
          <div className="flex w-full max-w-[1600px] gap-6 items-start mt-20">
            ...
            <div
              className={`${showSignerSidebar ? "flex-[0.5]" : "flex-[0.7] bg-white rounded-3xl shadow-2xl border border-[#2FAAE1]/30 overflow-hidden flex flex-col h-[85vh]"}`}
            >
              <div className="text-center py-5 border-b border-[#2FAAE1]/30 bg-gradient-to-r from-[#0C4F81]/5 to-[#2FAAE1]/5">
                <h2 className="text-2xl font-extrabold text-[#0C4F81]">
                  Pratinjau Dokumen
            ...
            <div
              className={`${showSignerSidebar ? "flex-[0.25]" : "flex-[0.3]"} bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-[#0C4F81]/10 p-8 relative overflow-hidden self-start mt-2`}
            >
            ...
            <div className="flex-[0.65] bg-white rounded-3xl shadow-2xl border border-[#2FAAE1]/30 p-6 flex flex-col h-[85vh]">
              <div className="text-center mb-4 border-b border-[#2FAAE1]/30 pb-3">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Berikut hasil akhir dokumen yang telah berhasil ditandatangani
                  secara digital.
                </p>
              </div>
            ...
            <div className="flex-[0.35] bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl border border-[#0C4F81]/10 relative overflow-hidden p-8 self-start mt-2">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Berikut ringkasan hasil akhir dokumen PDF yang telah
                  ditandatangani dengan sertifikat elektronik.
                </p>
              </div>
                ...
                <h3 className="text-sm font-bold text-[#0C4F81] mb-3 flex items-center gap-2">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M9 17v-2a2 2 0 012-2h2a2 2 0 012 2v2m4 0V9a2 2 0 00-2-2H7a2 2 0 00-2 2v8m4 4h8a2 2 0 002-2v-2H7v2a2 2 0 002 2z"
                    />
                  </svg>
                  Informasi Dokumen
                </h3>
